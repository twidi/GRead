...
if __name__ == "__main__":
    ...
    version = "1.0.2"           #Version of your software, for example "1.2.0" or "0.8.2"
    ...
    changeloginformation = "manage bad authentication & try to display as many as feeds as we can for the opened category" 
