...
if __name__ == "__main__":
    ...
    version = "1.0.7"           #Version of your software, for example "1.2.0" or "0.8.2"
    ...
    changeloginformation = "simple gestures in item list on mobile views : swipe to right to mark item as read, and to left to mark item as unread" 
