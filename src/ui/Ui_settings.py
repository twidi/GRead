...
#
# Created: Tue Aug 24 00:29:53 2010
...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -180, 498, 712))
        ...
        self.checkSettingsHomeShowUpdated = QtGui.QCheckBox(self.groupFeeds)
        self.checkSettingsHomeShowUpdated.setObjectName("checkSettingsHomeShowUpdated")
        self.horizontalLayout.addWidget(self.checkSettingsHomeShowUpdated)
        ...
        self.checkSettingsShowKeptUnread = QtGui.QCheckBox(self.groupSpecials)
        self.checkSettingsShowKeptUnread.setObjectName("checkSettingsShowKeptUnread")
        self.gridLayout.addWidget(self.checkSettingsShowKeptUnread, 2, 0, 1, 3)
        self.verticalLayout_2.addWidget(self.groupSpecials)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.labelSettingsHomeAllEntries = QtGui.QLabel(self.groupFeeds)
        self.labelSettingsHomeAllEntries.setObjectName("labelSettingsHomeAllEntries")
        self.horizontalLayout_2.addWidget(self.labelSettingsHomeAllEntries)
        self.selectSettingsHomeAllEntries = QtGui.QComboBox(self.groupFeeds)
        self.selectSettingsHomeAllEntries.setObjectName("selectSettingsHomeAllEntries")
        self.selectSettingsHomeAllEntries.addItem("")
        self.selectSettingsHomeAllEntries.addItem("")
        self.selectSettingsHomeAllEntries.addItem("")
        self.horizontalLayout_2.addWidget(self.selectSettingsHomeAllEntries)
        ...
        self.labelSettingsHomeAllEntries.setBuddy(self.selectSettingsHomeAllEntries)
        ...
        Settings.setTabOrder(self.selectSettingsHomeDefault, self.checkSettingsHomeShowUpdated)
        Settings.setTabOrder(self.checkSettingsHomeShowUpdated, self.checkSettingsShowStarred)
        ...
        Settings.setTabOrder(self.checkSettingsShowFriends, self.checkSettingsShowKeptUnread)
        Settings.setTabOrder(self.checkSettingsShowKeptUnread, self.selectSettingsHomeAllEntries)
        Settings.setTabOrder(self.selectSettingsHomeAllEntries, self.selectSettingsItemsShowMode)
    ...
    def retranslateUi(self, Settings):
        ...
        self.checkSettingsHomeShowUpdated.setText(QtGui.QApplication.translate("Settings", "Show updated only", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.checkSettingsShowKeptUnread.setText(QtGui.QApplication.translate("Settings", "Kept Unread", None, QtGui.QApplication.UnicodeUTF8))
        self.labelSettingsHomeAllEntries.setText(QtGui.QApplication.translate("Settings", "Entry \"all\" for each label", None, QtGui.QApplication.UnicodeUTF8))
        self.selectSettingsHomeAllEntries.setItemText(0, QtGui.QApplication.translate("Settings", "Hide", None, QtGui.QApplication.UnicodeUTF8))
        self.selectSettingsHomeAllEntries.setItemText(1, QtGui.QApplication.translate("Settings", "Top", None, QtGui.QApplication.UnicodeUTF8))
        self.selectSettingsHomeAllEntries.setItemText(2, QtGui.QApplication.translate("Settings", "Bottom", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.selectSettingsItemsShowMode.setItemText(1, QtGui.QApplication.translate("Settings", "Default updated, save each", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.selectSettingsItemsShowMode.setItemText(3, QtGui.QApplication.translate("Settings", "Default updated, no save", None, QtGui.QApplication.UnicodeUTF8))
