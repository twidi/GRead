...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -138, 498, 762))
        ...
        self.spinSettingsZoomFactor.setProperty("value", 99)
        ...
        self.verticalLayout_31.setContentsMargins(-1, 19, -1, -1)
